...
- [#303](https://github.com/dimfeld/svelte-maplibre/pull/303) [`a3d2a77`](https://github.com/dimfeld/svelte-maplibre/commit/a3d2a77fa250ea6d6087290780025fa5da949b03) Thanks [@firatciftci](https://github.com/firatciftci)! - Support maplibre-gl 6. The required `maplibre-gl` version is now `^6.0.0`; versions 4 and 5 are no longer supported.
